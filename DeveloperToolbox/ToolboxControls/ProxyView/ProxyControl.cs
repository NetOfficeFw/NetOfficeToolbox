...
namespace NetOffice.DeveloperToolbox.ToolboxControls.ProxyView
{
    public partial class ProxyControl : UserControl, IToolboxControl
    {
        ...
        public Image Icon
        {
            get { return Resources.ResourceUtils.ReadImageFromResource("ToolboxControls.ProxyView.ProxyView.png"); }
        }
        ...
        {
            return Resources.ResourceUtils.ReadStream("ToolboxControls.ProxyView.Info1033.rtf");
        }
